      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            prefixUrl =
              lastIndexOfSlash >= 0
                ? modelUrl.slice(0, lastIndexOfSlash + 1)
                : "";
          ...
          switch (_a.label) {
            ...
            case 1:
              ...
              result = Array.from(probabilities).map(function (prob, i) {
                return { label: _this.dictionary[i], prob: prob };
              });
        ...
        return __generator(this, function (_f) {
          switch (_f.label) {
            case 0:
              ...
              img = tfjsCore.tidy(function () {
                return _this.preprocess(input, options);
              });
              (_a = [img.shape[1], img.shape[2]]),
                (height = _a[0]),
                (width = _a[1]);
              feedDict = {};
            ...
            case 2:
              ...
              (_e = calculateMostLikelyLabels(scores, numBoxes, numClasses)),
                (boxScores = _e.boxScores),
                (boxLabels = _e.boxLabels);
              return [
                4 /*yield*/,
                tfjsCore.image.nonMaxSuppressionAsync(
                  boxesTensor,
                  boxScores,
                  options.topk,
                  options.iou,
